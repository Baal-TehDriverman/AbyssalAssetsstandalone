...
class SandboxManager:
    ...
    def create_sandboxed_process(self,
        ...
        cmd: Command to execute
            security_level: Security SecurityLevel (uses default if None)
...
if __name__ == "__main__":
    ...
    net_tests_low = [
        ...
        ("evil.com", 22, False),     # Should be blocked (blocked port)
    ]
    ...
    result = run_sandboxed(
        ["sleep", "5"],  # This should complete fine
    ...
    print(f"\nActive sandboxes: {len(sandbox_manager.get_active_sandboxes())}")
